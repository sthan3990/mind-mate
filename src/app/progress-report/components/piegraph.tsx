...
const PieGraphComponent: React.FC = () => {
  ...
  const sortMoodData = () => {
    ...
    const updatedPreMoodData: { name: string, value: number, percentage: number }[] = [
...
return (
  <div>
    ...
    <PieChart width={730} height={250}>
      <Pie data={preMoodData} dataKey="percentage"  cx="50%" cy="50%" outerRadius={50} fill="#8884d8" label />
    </PieChart>

    <Text>Your Mood After Journal - Range is all of time right now</Text>
    <PieChart width={730} height={250}>
      <Pie data={postMoodData} dataKey="percentage" cx="50%" cy="50%" outerRadius={50} fill="#82ca9d" label />
    </PieChart>

    <Text>Breakdown of Number of Questions</Text>
    <PieChart width={730} height={250}>
      <Pie data={graphData} dataKey="num_questions" cx="50%" cy="50%" outerRadius={50} fill="#82ca9d" label />
    </PieChart>
